...
export default class EmployeeSearch extends React.Component {
    ...
    abcSort = () => {
        this.setState({employees: this.state.results.sort((a, b) => a.name.first.localeCompare(b.name.first))})
    }
    ...
    filterRes = () => {
        ...
        this.setState({displayEmps: filteredRes})
    }
